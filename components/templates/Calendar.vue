...
export default {
    ...
    data() {
        return {
            calendar: [],
            bookings: [
                {id: 1, from: new Date('2021/02/17 11:30:00'), to: new Date('2021/02/17 12:00:00')},
                {id: 2, from: new Date('2021/02/17 13:00:00'), to: new Date('2021/02/17 14:00:00')},
                {id: 3, from: new Date('2021/02/17 17:00:00'), to: new Date('2021/02/17 19:30:00')},
                {id: 4, from: new Date('2021/02/19 10:00:00'), to: new Date('2021/02/17 11:00:00')},
                {id: 5, from: new Date('2021/02/18 14:00:00'), to: new Date('2021/02/18 16:30:00')},
                {id: 6, from: new Date('2021/02/20 13:00:00'), to: new Date('2021/02/20 18:00:00')},
                {id: 7, from: new Date('2021/02/18 17:00:00'), to: new Date('2021/02/18 18:00:00')},
                {id: 8, from: new Date('2021/02/21 13:30:00'), to: new Date('2021/02/18 17:00:00')},
                {id: 9, from: new Date('2021/02/24 11:00:00'), to: new Date('2021/02/24 15:30:00')},
